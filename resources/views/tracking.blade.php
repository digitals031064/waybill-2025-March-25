        ...
        <div class="mt-8 flex-col justify-center p-12 bg-gray-100 rounded-xl">
            <form class="max-w-md mx-auto" method="GET" action="{{route('waybills.track')}}"> 
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" name="waybill_no" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="insert waybill number ex. 123456" required />
